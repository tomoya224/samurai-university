...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220303_samuraiuniversity_cc8d5ee2c11a0e2a7920_20220303123943_archive.zip';
	const ARCHIVE_SIZE		 = '39140455';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'cc8d5ee-03123943';
    const SECONDARY_PACKAGE_HASH = '6f44cef-03123943';
	const VERSION			 = '1.4.4';
